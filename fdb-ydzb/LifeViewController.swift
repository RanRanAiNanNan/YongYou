...
class LifeViewController:BaseViewController, UIWebViewDelegate {
...
//    }
    ...
    func loadUrl(){
        let path = NSBundle.mainBundle().pathForResource("./hybrid/lifeService", ofType: "html")
...
//        }else{
//            KGXToast.showToastWithMessage("抱歉，客服暂时无法连接，请稍后再试", duration: ToastDisplayDuration.LengthShort)
//        }
//        
