//
//  PrivateOrderIntroduceViewController.swift
//  ydzbapp-hybrid
//
//  Created by 刘驰 on 15/7/21.
...
class PrivateOrderIntroduceViewController:BaseViewController, UIWebViewDelegate {
    ...
    func loadUrl(){
        let path = NSBundle.mainBundle().pathForResource("./hybrid/freedom", ofType: "html")
...
//        print("------didReceiveMQMessages------")
//        //        let noReadNum = UIApplication.sharedApplication().applicationIconBadgeNumber
//        //        print("self 末读数:\(noReadNum)")
//        //        for  msg in message {
//        //            print("self 广播:\(msg.content)")
//        //            if !msg.content.isEmpty {
//        //                print("有内容")
//        //                let noReadNum = UIApplication.sharedApplication().applicationIconBadgeNumber
//        //                let localNotification = UILocalNotification()
//        //                localNotification.alertBody = msg.content
...
//    }
    ...
    func serviceContractClick() {
        ...
        let escapedStr = B.SERVICE_PRIVATEORDER.stringByAddingPercentEncodingWithAllowedCharacters(customAllowedSet)
    ...
    func returnClick(){
        ...
        //        let viewController:UIViewController = oneStoryBoard.instantiateViewControllerWithIdentifier("mainCtrl") as! UIViewController
