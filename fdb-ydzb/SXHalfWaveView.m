...
- (void)setPrecent:(float)progress avg:(float)precent description:(NSString *)description textColor:(UIColor *)tcolor bgColor:(UIColor *)bColor alpha:(CGFloat)alpha{
    [self.waveView setPrecent:progress avg:precent textColor:tcolor bgColor:bColor alpha:alpha clips:YES];
