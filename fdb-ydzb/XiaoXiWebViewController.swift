...
class XiaoXiWebViewController:BaseViewController {
    ...
    override func viewDidLoad() {
        ...
        webView.loadRequest(NSURLRequest(URL:NSURL(string:"http://121.43.118.86:10220/index.php/home/Index/message?id=\(passUrl)")!))
    }
