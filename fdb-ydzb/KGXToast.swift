...
//                print("windows = \(UIApplication.sharedApplication().windows)")
                baseWindow = UIWindow(frame: CGRectMake(0, 0, UIScreen.mainScreen().bounds.width, UIScreen.mainScreen().bounds.size.height))
//                baseWindow = UIApplication.sharedApplication().windows.last
        ...
        messageLabel.textColor = B.NAV_TITLE_CORLOR
        ...
        */
        ...
        // センタリング
        toastView.center = CGPointMake(baseWindow!.center.x, baseWindow!.bounds.height - toastView.bounds.height - 50)
