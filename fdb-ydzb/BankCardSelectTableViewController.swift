...
protocol SelectBankIdDelegate{
    func setSelectBankId(bankId:String);
}
class BankCardSelectTableViewController: BaseTableViewController {
    ...
    var delegate:SelectBankIdDelegate?
    ...
    override func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        ...
        if self.bandCardRecordData.count != indexPath.row {
            ...
            let cell:UITableViewCell = tableView.dequeueReusableCellWithIdentifier("RECHARGE_SELECT_BANKCARD_CELL", forIndexPath: indexPath) 
            //银行名
            ...
            let cell:UITableViewCell = tableView.dequeueReusableCellWithIdentifier("RECHARGE_SELECT_ADD_CELL", forIndexPath: indexPath) 
            return cell
       }
    }
    ...
    override func tableView(tableView: UITableView, didSelectRowAtIndexPath indexPath: NSIndexPath) {
        ...
        if self.bandCardRecordData.count != indexPath.row {
            //if oldSelectRow.toInt() != indexPath.row {
                ...
                bcm.type = "1"
                //print("oldSelectRow:\(oldSelectRow)")
