...
class YoYoActionSheet: UIView {
    ...
    init(title: String?, cancelButtonTitle: String?, buttonTitles: [String]?) {
        ...
        // 添加手势
        tap.addTarget(self, action: Selector("removeWindowsView"))
        ...
        for index in 0..<buttonTitles!.count {
            ...
            btn.addTarget(self, action:  Selector("actionSheetButton"), forControlEvents: .TouchUpInside)
            btn.addTarget(self, action:  Selector("actionSheetDowmAction"), forControlEvents: .TouchDown)
            btn.tag = index + 1
        ...
        if cancelButtonTitle != nil && cancelButtonTitle != "" { //是否添加取消按钮
            ...
            cancelBtn.addTarget(self, action: Selector("actionSheetButton"), forControlEvents: .TouchUpInside)
            cancelBtn.addTarget(self, action:  Selector("actionSheetDowmAction"), forControlEvents: .TouchDown)
