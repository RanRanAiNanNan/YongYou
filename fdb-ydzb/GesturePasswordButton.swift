...
//                CGContextSetRGBFillColor(context, 2/225, 174/255, 240/255, 1)
                CGContextSetRGBStrokeColor(context, 129/225, 144/255, 167/255, 1) //线条颜色
                CGContextSetRGBFillColor(context, 129/225, 144/255, 167/255, 1)
            }else{
            
//                CGContextSetRGBStrokeColor(context, 208/255, 36/255, 36/255,1);//线条颜色
//                CGContextSetRGBFillColor(context,208/255, 36/255, 36/255,1);
                CGContextSetRGBStrokeColor(context, 255/255, 161/255, 119/255,1)//线条颜色
                CGContextSetRGBFillColor(context,255/255, 161/255, 119/255,1)
            }
...
//             CGContextSetRGBFillColor(context, 30/225, 175/255, 235/255, 0.3)
            CGContextSetRGBFillColor(context, 129/225, 144/255, 167/255, 0.3)
        }else{
//            CGContextSetRGBFillColor(context, 208/225, 36/255, 36/255, 0.3)
            CGContextSetRGBFillColor(context, 255/255, 161/255, 119/255, 0.3)
        }
